    ...
    <div className="min-h-screen bg-background bg-grid flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-surface-2 border border-border rounded-2xl p-8">
          <h1 className="font-heading font-bold text-2xl text-warm mb-1">Welcome back</h1>
          <p className="text-muted text-sm mb-6">Sign in to continue creating</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-primary hover:bg-primary-hover disabled:opacity-50 text-white font-heading font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
